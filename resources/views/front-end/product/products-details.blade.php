									...
									<div class="flexslider">
										<ul class="slides">
											<li data-thumb="{{ asset('/') }}/front-end/images/si.jpg">
												<div class="thumb-image"> <img src="{{ asset('/') }}/front-end/images/
si.jpg" data-imagezoom="true" class="img-responsive"> </div>
											</li>
											<li data-thumb="{{ asset('/') }}/front-end/images/
si1.jpg">
												 <div class="thumb-image"> <img src="{{ asset('/') }}/front-end/images/
si1.jpg" data-imagezoom="true" class="img-responsive"> </div>
											</li>
											<li data-thumb="{{ asset('/') }}/front-end/images/
si2.jpg">
											   <div class="thumb-image"> <img src="{{ asset('/') }}/front-end/images/
si2.jpg" data-imagezoom="true" class="img-responsive"> </div>
											</li> 
										 </ul>
									</div>
								</div>
								<div class="single-right simpleCart_shelfItem">
									...
									<div class="description">
										<p><span>Quick Overview : </span>{{ $product->	product_long_desc }}</p>
									</div>
						...
						<div class="col-md-3 single-grid1">
							...
							<div class="recent-grids">
								<div class="recent-left">
									<a href="single.html"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/
r.jpg" alt=""></a>	
								</div>
...
r3.jpg" alt=""></a>	
									...
									<img class="img-responsive " src="{{ asset('/') }}/front-end/images/
woo2.jpg" alt="">
								</div>
													...
													<div class="descr">
														<div class="reviews-top">
															<div class="reviews-left">
																<img src="{{ asset('/') }}/front-end/images/
men3.jpg" alt=" " class="img-responsive">
															</div>
									...
									<div  class="grid-arrival">
										<figure>		
											<a href="single.html">
												<div class="grid-img">
													<img  src="{{ asset('/') }}/front-end/images/
p28.jpg" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
													<img  src="{{ asset('/') }}/front-end/images/
p27.jpg" class="img-responsive"  alt="">
												</div>			
											</a>		
										</figure>	
									</div>
									...
									<div  class="grid-arrival">
										<figure>		
											<a href="single.html">
												<div class="grid-img">
													<img  src="{{ asset('/') }}/front-end/images/
p30.jpg" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
													<img  src="{{ asset('/') }}/front-end/images/
p29.jpg" class="img-responsive"  alt="">
												</div>			
											</a>		
										</figure>	
									</div>
									...
									<div  class="grid-arrival">
										<figure>		
											<a href="single.html">
												<div class="grid-img">
													<img  src="{{ asset('/') }}/front-end/images/
s2.jpg" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
													<img  src="{{ asset('/') }}/front-end/images/
s1.jpg" class="img-responsive"  alt="">
												</div>			
											</a>		
										</figure>	
									</div>
									...
									<div  class="grid-arrival">
										<figure>		
											<a href="single.html">
												<div class="grid-img">
													<img  src="{{ asset('/') }}/front-end/images/
s4.jpg" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
													<img  src="{{ asset('/') }}/front-end/images/
s3.jpg" class="img-responsive"  alt="">
												</div>			
											</a>		
										</figure>	
									</div>
