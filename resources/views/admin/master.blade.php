...
<head>
  ...
  @yield('title')
    ...
    <!-- MetisMenu CSS -->
    <link href="{{ asset('/') }}/back-end/css/metisMenu.min.css" rel="stylesheet">
    ...
    <!--[if lt IE 9]>
        ...
        <script src="https://oss.maxcdn.com/libs/respond.{{ asset('/') }}/back-end/js/1.4.2/respond.min.js"></script>
    <![endif]-->
...
@yield('body')
    ...
    <script src="{{ asset('/') }}/back-end/js/morris-data.js"></script>
